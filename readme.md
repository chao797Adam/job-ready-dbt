...
![Revenue by Category Dashboard](job_ready_dbt/asset/dashboard-revenue%20per%20catelog.png)
...
```sql
-- Check all line items for ord_007 to verify item-level calculations
select 
    order_id, 
    product_id, 
    quantity, 
